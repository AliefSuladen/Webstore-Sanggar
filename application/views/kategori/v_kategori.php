            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="<?=base_url('kategori/add')?>"  type="button" class="btn btn-tool btn-sm" >
                  ...
                  <table class="table table-bordered" id="example2">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td class="text-center"> <img src="<?=base_url('asset/gambarkategori/'. $value->gambar_kategori)?>" width="150"></td>
