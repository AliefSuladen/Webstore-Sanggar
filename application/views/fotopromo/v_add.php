<div class="col-md-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                  ...
                  echo form_open_multipart('fotopromo/add/'.$produk->id_promo)?>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                      <?php foreach ($fotoproduk as $key => $value) {?>
                        <div class="col-sm-3">
                        <div class="form-group">
                            <img src="<?=base_url('asset/gambarpromo/'.$value->gambar)?>" id="gambar_load" width="250px" height="200px">       
                            </div>
       ...
       <div class="modal fade" id="delete<?= $value->id_gambar?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group ">
                            <img src="<?=base_url('asset/gambarpromo/'.$value->gambar)?>" id="gambar_load" width="" height="200px">       
                            </div>
           <h3>Apakah Anda Ingin Menghapus Foto Ini ??</h3>
            </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <a href="<?=base_url('fotopromo/delete/'.$value->id_promo.'/' .$value->id_gambar)?>" type="submit" class="btn btn-primary"> Hapus</a>
              <?php 
            echo form_close();
            ?>
            </div>
