        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="<?=base_url('asset/gambarbarang/'.$produk->gambar_produk) ?>" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="<?=base_url('asset/gambarbarang/'.$produk->gambar_produk) ?>" alt="Product Image"></div>

                <?php foreach ($gambar as $key => $value) {?>
                    <div class="product-image-thumb" ><img src="<?=base_url('asset/gambarbarang/'.$value->gambar) ?>" alt="Product Image"></div>
              <?php  }?>
