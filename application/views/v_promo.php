      ...
      <div class="col-12 col-sm-4  d-flex align-items-stretch ">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-12">
                    <img src="<?=base_url('asset/gambarpromo/'.$value->gambar_produk) ?>" alt="" class=" img-fluid" width="500px">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
                  ...
                  <div class="text-right">
                    <a href="<?=base_url('home/detail_promo/'.$value->id_promo)?>" class="btn btn-sm btn-primary">
                      <i></i>Lihat Detail
                    </a>
                    </div>
                  </div>
